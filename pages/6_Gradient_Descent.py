...
with st.sidebar:
    ...
    st.write(" - *learning rate*, which controls how much the parameters change with each update.")
    st.write(" - *batch size*, how many of the data points you want to consider in each step.  For stochastic gradient descent, use a batch size of 1.")
    st.write(" - *updates/epochs*, how many times you want to update the parameters.")
